...
(function (S, X, u) {
  ...
  function qc(b) {
    ...
    r((b || '').split('&'), function (b) {
      b && (c = b.replace(/\+/g, '%20').split('='), d = pc(c[0]), z(d) && (b = z(c[1]) ? pc(c[1]) : !0, Hb.call(a, d) ? B(a[d]) ? a[d].push(b) : a[d] = [
        a[d],
        b
      ] : a[d] = b));
    });
  ...
  function uc(b, a) {
    ...
    this.directive = function q(a, e) {
      Ka(a, 'directive');
      I(a) ? (Mb(e, 'directiveFactory'), d.hasOwnProperty(a) || (d[a] = [], b.factory(a + 'Directive', [
        '$injector',
        '$exceptionHandler',
        function (b, e) {
          var f = [];
    ...
    this.$get = [
      ...
      '$animate',
      '$$sanitizeUri',
      function (a, b, c, s, J, v, x, t, T, C, M) {
        function P(a, b) {
          try {
            a.addClass(b);
          } catch (c) {
      ...
      k.$formatters.push(function (a) {
        if (k.$isEmpty(a))
          ...
          if (!ea(a))
            throw Fb('datefmt', a);
          if ((n = a) && 'UTC' === p) {
            var b = 60000 * n.getTimezoneOffset();
  ...
  r({
    ...
    inheritedData: vb,
    scope: function (b) {
      return D.data(b, '$scope') || vb(b.parentNode || b, [
        '$isolateScope',
        '$scope'
      ]);
    },
  ...
  var td = function (a) {
    ...
    ], gb = 'ng-valid', qd = 'ng-invalid', Qa = 'ng-pristine', Db = 'ng-dirty', sd = 'ng-pending', Of = [
      '$scope',
      '$exceptionHandler',
      '$attrs',
      '$element',
